  ...
  return (
    <div className="h-screen mt-20 flex flex-col items-center justify-center">
      <Card className="bg-slate-100 w-[300px] flex flex-col p-5 gap-2">
        <DndContext
          ...
          onDragEnd={(e) => {
            ...
            if (over) {
              ...
              if (over.id == "droppable_lex") {
                if (active.id == "draggable_lex") setIsDropped2(true);
                else if (active.id == "draggable_ty") setIsDropped1(true);
              } else if (over.id == "droppable_ty") {
                // setIsDropped2(true);
                if (active.id == "draggable_ty") setIsDropped1(true);
                else if (active.id == "draggable_lex") setIsDropped2(true);
              }
            }
          }}
        >
        ...
        <button onClick={() => console.log({ isDropped1, isDropped2 })}>Check Order</button>
